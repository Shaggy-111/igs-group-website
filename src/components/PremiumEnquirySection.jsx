...
const PremiumEnquirySection = () => {
  ...
  try {
    ...
    const GOOGLE_SCRIPT_URL =
      "https://script.google.com/macros/s/AKfycbymWxARh86VAXCBwMTiYkjh9HotEiwkzX44SyoTEGlonncKYdwp0kMSKp0jJd4ld53eGQ/exec";
  ...
  const features = [
    { icon: <Package size={18} />, title: "Direct Factory & Wholesale Sourcing" },
    { icon: <Truck size={18} />, title: "Fast Delivery Across Noida & NCR" },
    { icon: <CheckCircle2 size={18} />, title: "GST Billing & Professional Support" },
    { icon: <Clock size={18} />, title: "Quick Quotation Within Few Hours" },
  ];
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto">
        <div className="text-center mb-16 max-w-5xl mx-auto">
          ...
          <h2 className="text-4xl md:text-6xl xl:text-7xl font-black leading-tight tracking-tighter text-white">
            Got Your Hands On <span className="text-blue-500">Best Quality</span>
            <br />
          ...
          <div className="grid lg:grid-cols-2">
            <div className="p-10 lg:p-14 border-r border-white/5 bg-gradient-to-br from-slate-950 to-slate-900 text-white">
              <div className="inline-flex items-center gap-3 mb-8">
                ...
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.25em] text-slate-400">Direct Support</p>
                </div>
              </div>
              <h3 className="text-4xl md:text-5xl font-black leading-tight tracking-tight mb-6">
                Still Confused?<br /><span className="text-blue-500 italic">Let Us Help You.</span>
              </h3>
              <p className="text-slate-300 leading-8 text-base mb-10 max-w-lg">
                IGS Group is a trusted corporate procurement partner in Noida & NCR for housekeeping materials, stationery, computer accessories and complete facility management supplies.
              </p>
              <Link to="/contact" className="inline-flex items-center gap-3 bg-white text-slate-950 px-8 py-4 rounded-xl font-black uppercase tracking-wider text-[11px] hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-xl">
            ...
            <div className="p-10 lg:p-14 bg-slate-950/95 text-white">
              <div className="bg-gradient-to-r from-blue-600 to-blue-500 rounded-3xl p-6 mb-8 shadow-2xl">
                <p className="text-[10px] font-black uppercase tracking-[0.25em] text-blue-100 mb-2">IGS Group Enterprises</p>
                <h3 className="text-3xl font-black leading-tight">Get Best Price Quotation</h3>
                <p className="text-blue-100 text-sm mt-1">Professional Bulk Supply Solutions</p>
              </div>

              {/* Organization Name */}
              <div className="mb-5">
                <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-2">Organization Name</label>
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-5">
                ...
                <div>
                  <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-2">Corporate Email</label>
                  <div className="relative">
              ...
              <div className="mb-5">
                <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-2">Supply Category</label>
                <select
                  name="category"
              ...
              <div className="mb-6">
                <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-2">Detailed Requirement</label>
                <div className="relative">
